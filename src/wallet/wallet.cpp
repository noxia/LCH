...
#define LCH_MODULUS   ""
...
bool CWallet::CreateZerocoinMintModel(string &stringError, string denomAmount) {
    ...
    bnTrustedModulus.SetHex(LCH_MODULUS);
...
//            LogPrintf("txNew:%s\n", txNew.ToString());
            ...
            bool setParams = bnTrustedModulus.SetHexBool(LCH_MODULUS);
            if (!setParams) {
                LogPrintf("[btzc] bnTrustedModulus.SetHexBool(LCH_MODULUS) failed");
            }
